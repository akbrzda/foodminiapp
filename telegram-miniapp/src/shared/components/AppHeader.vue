...
import { Menu, MapPin, X, Package, Gift, User, Phone } from "lucide-vue-next";
...
import { bonusesAPI, citiesAPI } from "@/shared/api/endpoints.js";
...
async function loadAppVersion() {
  try {
    ...
    appVersion.value = pkg.default?.version || pkg.version || "—";
  } catch (error) {
    appVersion.value = "—";
  }
}
