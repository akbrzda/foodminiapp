...
const applyForm = (settings = {}) => {
  ...
  form.value = {
    ...
    iiko_api_url: String(settings.iiko_api_url || ""),
    iiko_api_key: String(settings.iiko_api_key || ""),
    ...
    premiumbonus_api_url: String(settings.premiumbonus_api_url || ""),
    premiumbonus_api_token: String(settings.premiumbonus_api_token || ""),
    premiumbonus_sale_point_id: String(settings.premiumbonus_sale_point_id || ""),
