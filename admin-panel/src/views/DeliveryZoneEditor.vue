    ...
    <Card>
      <CardHeader class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <CardDescription>Редактирование полигона и параметров доставки</CardDescription>
        </div>
        <Button variant="outline" @click="goBack">Назад</Button>
      </CardHeader>
    </Card>
    ...
    <div class="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
      <Card>
        <CardContent class="p-3">
          <div id="editor-map" class="min-h-[520px] w-full rounded-lg lg:min-h-[70vh]"></div>
        </CardContent>
      </Card>
...
const initMap = () => {
  ...
  map = L.map(container, { zoomControl: true, attributionControl: false }).setView(center, 13);
